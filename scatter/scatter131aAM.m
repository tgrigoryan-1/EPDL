% Code for MAE131A Spring 25 Performance Scatter Final Exam / Participation After Midterm
...
participation = data.TotalAmount_ActiveRecall_ConceptMapOnly_;
exam_score = data.FinalExamRawScore_924780_;

% Scatter Plot
figure(1), scatter(participation,exam_score,50,'filled')
xlabel('Participation Count Total')
ylabel('Final Exam Score')
title('MAE131A: Participation vs. Final Exam Performance')
