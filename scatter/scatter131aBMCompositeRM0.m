% Code for MAE131A Spring 25 Performance Scatter Midterm Exam / Composite Participation Indicator Before Midterm Remove 0 Score
...
p_data = p_data(:,{'SISUserID','CompositeParticipationIndicatorBeforeMidterm_zScoreAvg_'});
...
indicator = data.CompositeParticipationIndicatorBeforeMidterm_zScoreAvg_;
...
ylim([5 55])
title('MAE131A: Composite Participation Indicator vs. Midterm Exam Performance')
