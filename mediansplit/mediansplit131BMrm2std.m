...
% This code runs the same code as mediansplit131BM.m but excluding two standard deviations above average
...
mean_score = mean(data.MidtermExam_971071_);
std_score = std(data.MidtermExam_971071_);
...
logvec = data.MidtermExam_971071_ >= lower_cutoff & data.MidtermExam_971071_ <= upper_cutoff;
